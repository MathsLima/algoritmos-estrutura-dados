...
public class SequentialSearchST<Key, Value> {
    ...
    public Value get(Key key) {
        ...
        for (Node x = first; x != null; x = x.next) {   //enquanto eu estiver dentro da lista 
            if (key.equals(x.key)) //se o valor da chave x for igual ao valor percorrido 
                return x.val;  //retorna o valor da chave x 
        }
        return null;
    }
    ...
    public void put(Key key, Value val) {
        ...
        //percorre toda a lista e verifica se o nodo ja existe, se nao existe cria um novo com o valor da chave 
