...
public class SeparateChainingHashST<Key, Value> {
    ...
    public Value get(Key key) {
        ...
        int i = hash(key); //calcula o hash da chave 
        return st[i].get(key); //referencia para o primeiro elemento 
    } 
     ...
     * @throws IllegalArgumentException if {@code key} is {@code null}
     */
    // se tentar inserir um valor nulo no dicionario ele deleta na hora
